...
// type ArrowColorType = "beige" | "black";
// type BgColorType = "purple" | "beige" | "green";
// type TopBorderColor = "darkPurple" | "darkBeige" | "darkGreen";
type ArrowButtonStyleKey = "purpleButton" | "greenButton" | "biegeButton";
type ArrowType = "left" | "right";

const ArrowButtonType = {
  purpleButton: {
    arrowColor: "biege",
    bgColorType: "grapePurple",
    topBorderColor: "darkPurple",
  },
  greenButton: {
    arrowColor: "biege",
    bgColorType: "leafGreen",
    topBorderColor: "darkGreen",
  },
  biegeButton: {
    arrowColor: "black",
    bgColorType: "biege",
    topBorderColor: "darkBeige",
  },
};
...
export default function ArrowButton({
  ...
  const { arrowColor, bgColorType, topBorderColor } =
    ArrowButtonType[arrowButtonColor];

  return (
    <>
      <button
        onClick={onClick}
        className={`relative rounded-2xl w-24 h-24 bg-${bgColorType} border-t-[${topBorderColor}] border-t-4`}
      >
        {direction === "left" ? (
