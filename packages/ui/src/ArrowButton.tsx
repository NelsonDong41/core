...
export default function ArrowButton({
  ...
  return (
    <>
      <button
        onClick={onClick}
        className={`relative rounded-2xl w-24 h-24`}
        style={{
          backgroundColor: Colors[bgColor],
          borderTop: `6px solid ${Colors[topBorderColor]}`,
        }}
      >
        {direction === "left" ? (
          <LeftArrow arrowColor={Colors[arrowColor]} />
        ) : (
          <RightArrow arrowColor={Colors[arrowColor]} />
        )}
      </button>
    </>
  );
